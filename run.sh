...
#g++ -std=c++0x -fPIC -c solver.cpp -o solver.o

# Link
echo "--> Link"
g++ -std=c++0x -shared -o libutils.so utils.o
g++ -std=c++0x -I /opt/homebrew/Cellar/eigen/3.4.0_1/include/eigen3/ numerical-methods.cpp -L. -lutils -o numerical-methods.o
